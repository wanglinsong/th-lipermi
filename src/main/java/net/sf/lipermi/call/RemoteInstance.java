...
public class RemoteInstance implements Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RemoteInstance) {
            ...
            boolean iid = ((getInstanceId() == null ? ri.getInstanceId() == null : getInstanceId()
                    .equals(ri.getInstanceId())) || (getInstanceId() != null && getInstanceId()
                    .equals(ri.getInstanceId())));
            boolean cn = getClassName().equals(ri.getClassName());
            return (cn && iid);
        }
        return false;
    }
